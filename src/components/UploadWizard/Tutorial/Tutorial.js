    ...
    <div className = { styles.tutorial }>
        ...
        <div className = { styles.sections } >
            ...
            <div className = { styles.section } >
                ...
                <p>
                    Part Types are categories of interchangeable parts
            ...
            <div className = { styles.section } >
                ...
                <p>
                    Parts are the individual CAD files that are
                ...
                <p>
                    Head A and Head B are both parts belonging
                    to the Head part type.
                </p>
            </div>
