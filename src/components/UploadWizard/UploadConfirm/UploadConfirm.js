...
class UploadConfirm extends Component {
    ...
    componentDidMount() {
        const { uploadedObjectGeometry } = this.props;
    ...
    renderPreview() {
        ...
        return showImage ? (
            <img className={styles.img} src={img.objectURL} />
        ) : (
            <CanvasContainer
    ...
    render() {
        ...
        const { tutorialHidden, name, img } = this.state;

        const showImage = Boolean(img);

        const className = cn(commonStyles.wizardStep, styles.container);
            ...
            <div className={className}>
                <div className={styles.uploadConfirm}>
                    ...
                    <div className={styles.gridView}>
                        ...
                        <span className={styles.label}>Part Name</span>
                        <input
                        ...
                        <div
                            className={cn(styles.view, styles.previewContaier)}
                        >
                            {this.renderPreview()}
                        ...
                        <div
                            className={cn(styles.view, styles.buttonsContainer)}
                        >
                            <div
                                className={cn(
                                    commonStyles.button,
